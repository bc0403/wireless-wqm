...
int DS18B20_Pin = 7; //DS18B20 Signal pin on digital 7
...
{ 
    ...
    ads.begin();
    ads.setGain(GAIN_ONE); // set PGA gain to 1 (LSB=0.125 mV)
} 
...
float getTemp(){
  ...
  if ( OneWire::crc8( addr, 7) != addr[7]) {
      ...
      Serial_BT.println("CRC is not valid!");
      return -1000;
  }

  if ( addr[0] != 0x10 && addr[0] != 0x28) {
      Serial.print("Device is not recognized");
      Serial_BT.print("Device is not recognized");
      return -1000;
  }
